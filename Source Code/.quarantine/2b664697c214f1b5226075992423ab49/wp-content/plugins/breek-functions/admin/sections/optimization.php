...
CSF::createSection( $opt_name, array(
	...
	'fields' => array(
        ...
        array(
			'id' => 'enable_desktop_animation',
			'type' => 'switcher',
            'title' => esc_html__('Enable Home Desktop Animation', 'epcl_framework'),
            // 'subtitle' => esc_html__('W3 Total Cache plugin recommended', 'epcl_framework'),
			'desc' => esc_html__('Disable (home, archives, etc) desktop animation could improve the Time to Interative (TTI), but it will produce some relayout on masonry grids. On mobile is always disabled.', 'epcl_framework'),
			'default' => true
        ),
        array(
			'id' => 'enable_single_desktop_animation',
			'type' => 'switcher',
            'title' => esc_html__('Enable Single Desktop Animation', 'epcl_framework'),
            // 'subtitle' => esc_html__('W3 Total Cache plugin recommended', 'epcl_framework'),
			'desc' => esc_html__('Disable (single post and pages) desktop animation could improve the Time to Interative (TTI), recommended OFF. On mobile is always disabled.', 'epcl_framework'),
			'default' => false
        ),
        array(
            ...
            'desc' => __('<b>Standard:</b> is render blocking but the CSS appears inmediatly.<br><b>Prefetch:</b> elements will appear when everything is already loaded and with low priority (not render blocking).<br><b>Preload:</b> elements will be preloaded even before other critical CSS elements, this will assign high priority (not render blocking).<br><b>Important:</b> if you are using PageSpeed on your hosting, standard method is recommended.', 'epcl_framework'),
            'options'  => array(
                'standard' => esc_html__('Standard (head)', 'epcl_framework'),
                'prefetch' => esc_html__('Prefetch (recommended)', 'epcl_framework'),
                'preload' => esc_html__('Preload', 'epcl_framework'),              
            ),
			'default' => 'prefetch'
        ),
        array(
