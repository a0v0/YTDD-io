		...
		array(
			...
			'layouts' => array(
				...
				'module_grid_categories' => array(
					...
					'label' => esc_html__('Grid Categories (Cluster)', 'epcl_framework'),
					'display' => 'row',
					'max' => 1,
					'sub_fields' => array(
						array (
                        ...
                        array(
							'key' => $prefix_key.'grid_cat_exclude',
							'name' => 'grid_cat_exclude',
							'label' => esc_html__('Excluded Categories', 'epcl_framework'),
							'type' => 'taxonomy',
							'instructions' => esc_html__('(Optional) Usefull if you dont want to display specific categories.', 'epcl_framework'),
							'taxonomy' => 'category',
							'field_type' => 'multi_select',
							'return_format' => 'id',
							'multiple' => 0,
				...
				'module_carousel' => array(
					...
					'sub_fields' => array(
                        ...
                        array(
							'key' => $prefix_key.'carousel_excluded_categories',
							'name' => 'carousel_excluded_categories',
							'label' => esc_html__('Excluded Categories', 'epcl_framework'),
							'type' => 'taxonomy',
							'instructions' => esc_html__('(Optional) Usefull if you dont want to display posts by specific category.', 'epcl_framework'),
							'taxonomy' => 'category',
							'field_type' => 'multi_select',
							'return_format' => 'id',
							'multiple' => 0,
