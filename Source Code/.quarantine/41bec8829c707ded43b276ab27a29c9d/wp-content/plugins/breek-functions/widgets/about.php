			...
			echo $before_widget;
                ...
                if( $author_id ):
                    ...
                    if( function_exists('get_field') ){
                        $custom_social = get_field('custom_social', 'user_'. $author_id );
                    }                  
                ?>
                        ...
                        <div class="info">
                            ...
                            <div class="social">
                                <?php if( $website ): ?>
                                    <a href="<?php echo esc_url($website); ?>" class="website translate-effect" target="_blank" rel="nofollow noopener" title="<?php esc_attr_e('Website', 'breek'); ?>: <?php echo esc_url($website); ?>"><i class="fa fa-globe"></i></a>
                                <?php endif; ?>
                                <?php if( $twitter ): ?>
                                    <a href="<?php echo esc_url($twitter); ?>" class="twitter translate-effect" target="_blank" rel="nofollow noopener" title="<?php esc_attr_e('Follow me on Twitter', 'breek'); ?>"><i class="fa fa-twitter"></i></a>
                                <?php endif; ?>
                                <?php if( $facebook ): ?>
                                    <a href="<?php echo esc_url($facebook); ?>" class="facebook translate-effect" target="_blank" rel="nofollow noopener" title="<?php esc_attr_e('Follow me on Facebook', 'breek'); ?>"><i class="fa fa-facebook"></i></a>
                                <?php endif; ?>
                                <?php if( isset($custom_social) && !empty($custom_social) ): ?>
                                    <?php foreach( $custom_social as $social ): ?>
                                        <a href="<?php echo esc_url($social['custom_social_url']); ?>" class="custom-social <?php echo esc_attr($social['custom_social_icon']); ?> translate-effect" target="_blank" rel="nofollow noopener" title="<?php echo esc_attr($social['custom_social_title']); ?>"><i class="<?php echo esc_attr($social['custom_social_icon']); ?>"></i></a>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                            </div>
                        </div>
