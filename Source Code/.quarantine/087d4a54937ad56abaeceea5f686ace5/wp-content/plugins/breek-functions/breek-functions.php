 ...
 * Description: This plugin enables core functions for <a href="https://1.envato.market/wp-breek-preview">Breek - High Speed Masonry Theme for Wordpress</a> by <a href="https://1.envato.market/ep-portfolio-themes">EstudioPatagon</a>.
 * Version: 3.5.2
...
defined( 'ABSPATH' ) or die( 'No script kiddies please!' ); // No direct access allowed
 ...
 if ( !class_exists('epcl_breek_theme_functions') ) {
    ...
    class epcl_breek_theme_functions {
        ...
        public function init_redux_framework( ) {
