			...
			echo $before_widget;
				...
				echo '<div class="icons title">';
                    ...
                    if( $epcl_theme['telegram_url'] && $enable_telegram != false )
						...
						echo '<a href="'.$epcl_theme['telegram_url'].'" class="telegram" target="_blank" rel="nofollow"><i class="fa fa-telegram"></i><p>'.esc_html__('Telegram', 'breek').' <span>'.esc_html__('Click To Join Our Channel!', 'breek').'</span></p></a>';  
