...
<head>
    ...
    <link rel="shortcut icon" href="<?php echo $config["url"]; ?>/assets/img/fav.png"/>
...
<input type="checkbox" id="click">
      ...
      <ul>
<li><a href="./youtube-video-downloader">YouTube</a></li>
<li><a href="./facebook-video-downloader">Facebook</a></li>
<li><a href="./twitter-video-downloader">Twitter</a></li>
<li><a href="./imdb-video-downloader">IMDB</a></li>
<li><a href="./reddit-video-downloader">Reddit</a></li>
    ...
    <div class="row">
        <div class="col-md-8 ml-auto mr-auto text-center">
            ...
            <div class="form-group">
                ...
                <span style="font-weight:800;">Supported Hosts :</span> YouTube, Facebook, IMDB and many more
            </div>
        </div>
    </div>
</div>
